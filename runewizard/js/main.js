...
var Runewords = [
	...
	{ title: "Bramble", runes: ['Ral','Ohm','Sur','Eth'], level:"63", ttype:"Body Armor" },
	{ title: "Breath of the Dying", runes: ['Vex','Hel','El','Eld','Zod','Eth'], level:"69", ttype:"Weapons" },
	{ title: "Call To Arms", runes: ['Amn','Ral','Mal','Ist','Ohm'], level:"57", ttype:"Weapons" },
	{ title: "Chaos", runes: ['Fal','Ohm','Um'], level:"57", ttype:"Claws" },
	{ title: "Chains of Honor", runes: ['Dol','Um','Ber','Ist'], level:"63", ttype:"Body Armor" },
	{ title: "Crescent Moon", runes: ['Shael','Um','Tir'], level:"47", ttype:"Axes/Swords/Polearms/Spears" },
	{ title: "Delirium", runes: ['Lem','Ist','Io'], level:"51", ttype:"Helms" },
	{ title: "Doom", runes: ['Hel','Ohm','Um','Lo','Cham'], level:"67", ttype:"Axes/Polearms/Spears/Hammers" },
	...
	{ title: "Famine", runes: ['Fal','Ohm','Ort','Jah'], level:"65", ttype:"Axes/Hammers/Swords" },
	...
	{ title: "Wind", runes: ['Sur','Sur','El'], level:"61", ttype:"Melee Weapons" },
	/* 1.10 LADDER */
	...
	{ title: "Destruction", runes: ['Vex','Lo','Ber','Jah','Ko'], level:"65", ttype:"Polearms/Spears/Swords", ladder:true },
	...
	{ title: "Infinity", runes: ['Ber','Mal','Ber','Ist'], level:"63", ttype:"Polearms/Spears", ladder:true },
	{ title: "Insight", runes: ['Ral','Tir','Tal','Sol'], level:"27", ttype:"Polearms/Staves/Spears", ladder:true },
	...
	{ title: "Obedience", runes: ['Hel','Ko','Thul','Eth','Fal'], level:"41", ttype:"Polearms/Spears", ladder:true },
	{ title: "Phoenix", runes: ['Vex','Vex','Lo','Jah'], level:"65", ttype:"Weapons/Shields", ladder:true },
	{ title: "Pride", runes: ['Cham','Sur','Io','Lo'], level:"67", ttype:"Polearms/Spears", ladder:true },
	{ title: "Rift", runes: ['Hel','Ko','Lem','Gul'], level:"53", ttype:"Polearms/Spears/Scepters", ladder:true },
	{ title: "Spirit", runes: ['Tal','Thul','Ort','Amn'], level:"25", ttype:"Swords/Shields", ladder:true },
